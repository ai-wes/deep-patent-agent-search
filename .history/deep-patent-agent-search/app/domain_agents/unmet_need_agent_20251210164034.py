...
unmet_need_pipeline = SequentialAgent(
    ...
    description="Researches unmet need data, performs strategic analysis, synthesizes brief, and produces commercial landscape/unmet-need rating.",
    sub_agents=[
        unmet_need_researcher,
        unmet_need_strategist,
        unmet_need_strategic_brief,
        unmet_need_reviewer,
    ],
)
